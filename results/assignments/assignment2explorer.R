...
#-0.8611829 there is a negative correlation between these 2 variables because as one increases
#the other one decreases. when there is a high area the altitude is low