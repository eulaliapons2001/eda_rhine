#QUESTION1
#the 50th percentile is the median, so it's the same

#QUESTION2
#when the median and the mean are not the same it's because the data is not normally distributed
...
#to the sea. It is probably due to the altitude of the station which it is at not the actual
